function w = Four_Panel_4_Layer_Mode_1(i11,i12,i13,i141,i142,i143,i2,Ng,N1,N2,O1,O2)

%Case 4 panel, 4 layer, Ng = 4
...
%% w = 1/(sqrt(3) * [ w_141_l,m,p,n  w_141_l',m',p,n  w_241_l,m,p,n  w_241_l',m',p,n]
...
w_2412 = (1/sqrt(P_CSI_RS))*[ v_l_m_1;
                              -phi_n*v_l_m_1;
                              phi_p1*v_l_m_1;
                              -phi_n*phi_p1*v_l_m_1;
                              phi_p2*v_l_m_1;
...
w = (1/sqrt(3)) * [ w_1411 w_1412 w_2411 w_2412];
