function w = Seven_Layer(i11, i12, i2, N1, N2, O1, O2)
...
elseif ((N1 >= 2) && (N2 >= 2))
    ...
    disp('Error at case_1_7_1_1');
end

n = i2;

%% phi_n, u_m, v_l_m, number of antenna
...
% Calculate W
w = (1/(sqrt(7*P_CSI_RS)))*([   v_l_m           v_l_m           v_l_m_1         v_l_m_2    v_l_m_2    v_l_m_3   v_l_m_3       ;
                                phi_n*v_l_m     -1*phi_n*v_l_m  phi_n*v_l_m_1	v_l_m_2    -1*v_l_m_2 v_l_m_3	-1*v_l_m_3    ]);
