function w = One_Layer_Mode_2_1(i11,i12,i2,N1,N2,O1,O2)

%Case Mode = 2, N2 > 1
%% Parameters l, m, n
if (((i2 >= 0) && (i2 <= 3)) || ((i2 >= 8) && (i2 <= 11)))
    l = 2*i11;
elseif (((i2 >= 4) && (i2 <= 7)) || ((i2 >= 12) && (i2 <= 15)))
    l = 2*i11+1;
else
...
%% phi_n, u_m, v_l_m number of antenna ports
phi_n = func_phi_n(n);
