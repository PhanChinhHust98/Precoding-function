...
%                     'Weights',wt1_1layer);
%                 
%                 bz = pattern(txarray,fc,AzRange,0,...
%                     'PropagationSpeed',c,...
%                     'CoordinateSystem','polar',...
%                     'Type','powerdB',...
%                     'Weights',wt1_2layer);
                ...
                subplot(4,4,9);
                clear plot
                plot(AzRange,az51,"b",AzRange,az52,"r");
                axis ([-100 100 -50 0]);
                grid on;
                
                subplot(4,4,11);
                clear plot
                plot(AzRange,az61,"b",AzRange,az62,"r");
                axis ([-100 100 -50 0]);
                grid on;
                
                subplot(4,4,13);
                clear plot
                plot(AzRange,az71,"b",AzRange,az72,"r");
                axis ([-100 100 -50 0]);
                grid on;
                
                subplot(4,4,15);
                clear plot
                plot(AzRange,az81,"b",AzRange,az82,"r");
                axis ([-100 100 -50 0]);
                grid on;
...
%                     'Weights',wt1_1layer);
                ...
                subplot(4,4,10);
                plot(ElRange,el51,"b",ElRange,el52,"r");
                axis ([-100 100 -50 0]);
                grid on;
                
                subplot(4,4,12);
                plot(ElRange,el61,"b",ElRange,el62,"r");
                axis ([-100 100 -50 0]);
                grid on;
                
                subplot(4,4,14);
                plot(ElRange,el71,"b",ElRange,el72,"r");
                axis ([-100 100 -50 0]);
                grid on;
                
                subplot(4,4,16);
                plot(ElRange,el81,"b",ElRange,el82,"r");
                axis ([-100 100 -50 0]);
                grid on;
